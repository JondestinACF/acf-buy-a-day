      ...
      <header className="bg-acf-blue shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <a href="https://www.albanycommunity.org" target="_blank" rel="noopener noreferrer"
  ...
  return (
    <div className="text-center py-4">
      <p className="text-gray-600 text-sm mb-4">
        Your donation to the <a href="https://www.albanycommunity.org" target="_blank" rel="noopener noreferrer" className="underline hover:opacity-80">Albany Community Foundation</a> has been received.
